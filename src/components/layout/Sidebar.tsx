...
const navItems = [
  ...
  { href: '/dashboard/seo-report', label: 'SEO Report', icon: Search },
    ...
    <aside className="w-64 min-h-screen bg-surface-800 border-r border-surface-500 flex flex-col">
      ...
      <div className="px-6 py-5 border-b border-surface-500">
        <Link href="/" className="flex items-center gap-2.5">
          ...
          <div>
            <div className="text-sm font-bold text-zinc-100">Growth</div>
            <div className="text-xs text-zinc-500 -mt-0.5">Website Generator</div>
          </div>
        </Link>
      </div>
      ...
      <div className="px-6 py-4 border-t border-surface-500">
        ...
        <p className="text-xs text-zinc-700 mt-0.5">v1.0.0</p>
      </div>
    </aside>
  );
}
